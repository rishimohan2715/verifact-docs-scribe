  ...
  head: () => ({
    meta: [
      { title: "New Consultation — Verifact Local" },
      {
        name: "description",
        content:
          "Record or test a clinical consultation with local Whisper STT, ICD-10 auto-mapping, and Ollama MedGemma report generation.",
      },
    ],
  }),
...
const SAMPLE_TRANSCRIPTS = [
  {
    ...
    description:
      "Acute Decompensated Heart Failure, Chest Tightness, 5kg Edema, Epigastric Pain, 168/98 BP, Med Non-adherence",
    segments: [
      {
        speaker: "DOCTOR" as const,
        time: "00:00",
        text: "Good morning Mrs. Krishnan. Please take a seat. What brings you to the hospital today?",
      },
      {
        speaker: "PATIENT" as const,
        time: "00:07",
        text: "Doctor, over the last two weeks I've been feeling extremely unwell. The main problem is severe shortness of breath, especially when I try to walk even short distances like going to the bathroom. At night, I can't sleep flat anymore; I have to prop myself up with three heavy pillows just to catch my breath.",
      },
      {
        speaker: "DOCTOR" as const,
        time: "00:29",
        text: "I see. Have you noticed any chest discomfort, tightness, or swelling in your legs?",
      },
      {
        speaker: "PATIENT" as const,
        time: "00:36",
        text: "Yes, doctor. I have a heavy, dull tightness across my mid-chest that comes and goes. And my feet and ankles are severely swollen—my shoes don't fit at all now. I checked my weight at home and I've gained almost five kilos in just ten days.",
      },
      {
        speaker: "DOCTOR" as const,
        time: "00:55",
        text: "Alright. Any nausea, stomach discomfort, or changes in your urination?",
      },
      {
        speaker: "PATIENT" as const,
        time: "01:03",
        text: "Yes, my upper stomach has been paining quite a bit after meals, and I feel nauseousness throughout the morning. Also, I've been peeing four to five times every night, which wakes me up constantly.",
      },
      {
        speaker: "DOCTOR" as const,
        time: "01:19",
        text: "Have you been taking your prescribed medications regularly?",
      },
      {
        speaker: "PATIENT" as const,
        time: "01:25",
        text: "Honestly doctor, no. Since my sister passed away last month, I've been very depressed and stopped taking my blood pressure and heart failure pills regularly. I missed doses for days at a time.",
      },
      {
        speaker: "DOCTOR" as const,
        time: "01:43",
        text: "Thank you for telling me. Let's do a physical examination now. Your blood pressure is elevated at 168/98 mmHg, heart rate is 98 beats per minute, and pulse oximetry shows oxygen saturation at 92% on room air. Listening to your lungs, there are bilateral basilar crackles, and you have 3+ pitting bilateral pedal edema up to mid-calf. Your abdomen has mild epigastric tenderness.",
      },
      {
        speaker: "PATIENT" as const,
        time: "02:19",
        text: "That sounds concerning doctor. What is the plan?",
      },
      {
        speaker: "DOCTOR" as const,
        time: "02:25",
        text: "We are admitting you to the cardiology inpatient ward immediately. We will start IV Furosemide 40mg twice daily to remove excess fluid, restart your ACE inhibitor Ramipril 5mg daily for blood pressure, and give Pantoprazole 40mg for epigastric distress. We will also order stat ECG, Troponin, NT-proBNP, Serum Creatinine, and Echocardiogram.",
      },
      {
        speaker: "PATIENT" as const,
        time: "02:59",
        text: "How long will I need to stay in the hospital?",
      },
      {
        speaker: "DOCTOR" as const,
        time: "03:04",
        text: "Usually 3 to 5 days until we achieve good diuresis, your weight stabilizes, and your oxygen saturation returns to normal. Once discharged, you must follow up in the outpatient cardiology clinic in 7 days.",
      },
      {
        speaker: "PATIENT" as const,
        time: "03:25",
        text: "Understood doctor. Thank you so much for taking care of me.",
      },
    ],
  },
  {
    ...
    segments: [
      {
        speaker: "PATIENT" as const,
        time: "00:00",
        text: "Okay, so my stomach was paining and I had a lot of nauseousness and my face also kind of",
      },
      {
        speaker: "PATIENT" as const,
        time: "00:11",
        text: "started drooping and I peed four-five times.",
      },
    ],
  },
  {
    ...
    segments: [
      {
        speaker: "DOCTOR" as const,
        time: "00:00",
        text: "Mr. Kumar, your blood pressure today is 152 over 94, and your fasting blood sugar is 185.",
      },
      {
        speaker: "PATIENT" as const,
        time: "00:12",
        text: "Doctor, I missed taking my Glycomet for a few days when I travelled last week.",
      },
      {
        speaker: "DOCTOR" as const,
        time: "00:24",
        text: "We need to adjust your Metformin dose and add Amlodipine 5mg once daily to control your BP.",
      },
    ],
  },
];
...
function NewConsultation() {
  ...
  async function start() {
    ...
    try {
      ...
      setPhase("recording");
      toast.info(
        `Recording started. Speaker set: ${firstSpeaker} · Model: Whisper ${whisperModel}`,
      );
    } catch (error) {
  ...
  async function stop() {
    ...
    if (mediaRecorderRef.current && mediaRecorderRef.current.state !== "inactive") {
      if (typeof mediaRecorderRef.current.requestData === "function") {
        try {
          ...
          // Some browsers throw if requestData() is called right as the recorder stops;
          // the already-buffered chunks from ondataavailable are still used below.
        }
      }
    ...
    if (audioBlob.size === 0) {
      toast.error(
        "No audio data recorded from microphone. Please check mic permissions and try again.",
      );
      setPhase("idle");
      return;
    }
  ...
  async function generateRandomCaseLive() {
    ...
    try {
      ...
      console.warn(
        "Local backend unreachable for random case generation, falling back to client-side generator:",
        err,
      );
      ...
      const packages = [
        {
          ...
          sections: {
            chiefComplaint:
              "Severe right lower quadrant abdominal pain, nausea, and vomiting for 24 hours.",
            ...
            examination:
              "Temp 38.4°C, HR 94, BP 124/78. Abdomen: Severe McBurney's point tenderness with rebound tenderness and voluntary guarding. WBC 14,800/mcL.",
            diagnosis:
              "1. Acute Appendicitis (ICD-10: K35.80)\n2. Uncomplicated post-operative status following laparoscopic appendectomy",
            treatment:
              "1. Laparoscopic Appendectomy completed without complications\n2. IV Cefuroxime 1.5g + Metronidazole 500mg single pre-op dose\n3. Paracetamol 1g QDS PRN for wound discomfort\n4. Wound care & discharge instructions provided",
            followUp:
              "Follow-up in outpatient surgical clinic in 7 days. Return to ER if fever >38.5°C, persistent vomiting, or worsening wound redness occurs.",
          },
          icd10Codes: [
            {
              code: "K35.80",
              title: "Unspecified acute appendicitis",
          ...
          transcript: [
            {
              speaker: "DOCTOR" as const,
              time: "00:00",
              text: `Good afternoon ${patientName}. What brings you to the hospital today?`,
            },
            {
              speaker: "PATIENT" as const,
              time: "00:06",
              text: "Doctor, I have severe pain in my lower right belly that started yesterday around my belly button.",
            },
            {
              speaker: "DOCTOR" as const,
              time: "00:18",
              text: "On a scale of 1 to 10, how severe is the pain and do you have any nausea or fever?",
            },
            {
              speaker: "PATIENT" as const,
              time: "00:26",
              text: "It's an 8 out of 10. I threw up twice this morning and feel very feverish.",
            },
            {
              speaker: "DOCTOR" as const,
              time: "00:35",
              text: "Exam shows McBurney point tenderness. We are sending you for stat abdominal ultrasound and general surgery consult.",
            },
          ],
        },
        {
          ...
          sections: {
            ...
            examination:
              "SpO2 91% on room air, RR 26, HR 108. Lungs: Diffuse expiratory wheezing bilaterally, prolonged expiratory phase.",
            diagnosis:
              "1. Acute Severe Asthma Exacerbation (ICD-10: J45.901)\n2. Acute Bronchospasm",
            treatment:
              "1. Nebulized Salbutamol 2.5mg + Ipratropium 500mcg stat\n2. Oral Prednisolone 40mg daily for 5 days\n3. Supplemental O2 via nasal cannula to maintain SpO2 >94%",
            followUp:
              "Follow-up in respiratory clinic in 5 days. Return immediately if severe dyspnea or inability to complete full sentences occurs.",
          },
          icd10Codes: [
            {
              code: "J45.901",
              title: "Unspecified asthma with (acute) exacerbation",
          ...
          transcript: [
            {
              speaker: "DOCTOR" as const,
              time: "00:00",
              text: `Hello ${patientName}. How can I help you today?`,
            },
            {
              speaker: "PATIENT" as const,
              time: "00:05",
              text: "Doctor, I can't catch my breath. My chest feels tight and my inhaler isn't working.",
            },
            {
              speaker: "DOCTOR" as const,
              time: "00:16",
              text: "I hear wheezing. Oxygen is 91%. We are starting nebulization right now.",
            },
          ],
        },
        {
          ...
          sections: {
            chiefComplaint:
              "Crushing retrosternal chest pain radiating to left arm and jaw for 45 minutes.",
            ...
            examination:
              "BP 158/94 mmHg, HR 104 bpm, SpO2 95% on room air. 12-lead ECG demonstrates 2mm ST-segment depression in leads V4-V6.",
            diagnosis:
              "1. Acute Coronary Syndrome (ACS) / Non-ST Elevation Myocardial Infarction (ICD-10: I21.9)\n2. Essential Hypertension (ICD-10: I10)",
            treatment:
              "1. Chewable Aspirin 325mg + Sublingual Nitroglycerin stat\n2. Cardiac telemetry admission and stat Troponin T drawing\n3. Clopidogrel 300mg loading dose and IV Heparin protocol",
            followUp:
              "Cardiology outpatient review in 7 days. Return to ER immediately if chest tightness or diaphoresis recurs.",
          },
          icd10Codes: [
            {
              code: "I21.9",
              title: "Acute myocardial infarction, unspecified (ACS)",
          ...
          transcript: [
            {
              speaker: "DOCTOR" as const,
              time: "00:00",
              text: `Good afternoon ${patientName}. What brings you in today?`,
            },
            {
              speaker: "PATIENT" as const,
              time: "00:05",
              text: "Doctor, I have crushing chest pain shooting down my left arm and lower jaw.",
            },
            {
              speaker: "DOCTOR" as const,
              time: "00:15",
              text: "We are giving you Aspirin and Nitroglycerin under your tongue stat and drawing Cardiac Troponin.",
            },
          ],
        },
      ];
  ...
  async function loadPresetSample(sample: (typeof SAMPLE_TRANSCRIPTS)[0]) {
    ...
    const fallbackNote = {
      ...
      sections: {
        chiefComplaint:
          "Patient presents with severe exertional dyspnea, 3-pillow orthopnea, dull mid-chest tightness, 5kg rapid weight gain with 3+ bilateral pedal edema, postprandial epigastric pain, nausea, and nocturia (4-5 times per night).",
        ...
        examination:
          "Vital Signs: BP 168/98 mmHg, HR 98 bpm, SpO2 92% on room air. Lungs: Bilateral basilar crackles. Heart: S1, S2 present, regular rhythm. Abdomen: Soft with mild epigastric tenderness, no organomegaly. Extremities: 3+ pitting bilateral pedal edema up to mid-calf.",
        diagnosis:
          "1. Acute Decompensated Heart Failure (ADHF) / Volume Overload (ICD-10: I50.9)\n2. Essential Hypertension - Hypertensive Urgency (ICD-10: I10)\n3. Dyspepsia / Epigastric Pain (ICD-10: R10.9, R11.2)\n4. Polyuria / Nocturia (ICD-10: R35.0)\n5. Medication Non-Adherence secondary to bereavement",
        treatment:
          "1. Urgent Inpatient Cardiology Admission\n2. IV Furosemide 40mg BD for aggressive diuresis & fluid management\n3. Ramipril 5mg OD (restarted) for blood pressure & cardioprotection\n4. Pantoprazole 40mg OD before breakfast for epigastric distress\n5. Stat Labs: ECG, Troponin, NT-proBNP, Serum Creatinine, and 2D Echocardiogram",
        followUp:
          "Inpatient stay estimated 3 to 5 days until dry weight is achieved and oxygen saturation normalizes on room air. Outpatient Cardiology follow-up scheduled in 7 days post-discharge. Return to ER immediately if chest tightness worsens or severe breathlessness recurs.",
      },
      icd10Codes: [
        {
          code: "I50.9",
          title: "Heart failure, unspecified (Acute decompensated HF)",
          category: "Cardiovascular",
        },
        { code: "I10", title: "Essential (primary) hypertension", category: "Cardiovascular" },
        ...
        {
          code: "R60.0",
          title: "Localized edema (Bilateral pedal edema)",
          category: "Cardiovascular",
        },
      ],
      snomedCodes: [],
  ...
  async function processAudioPayload(audioBlob: Blob, filename: string) {
    try {
      ...
      setProcessingStatus(
        "Auto-matching ICD-10 codes, prescriptions & drafting report with Ollama LLM...",
      );
      const data = await res.json();
      ...
      setProcessingError(null);
      toast.success(
        `High-Accuracy Whisper (${data.whisper_model || whisperModel}) & Ollama Report Generation Complete!`,
      );
      navigate({ to: "/notes/$noteId", params: { noteId: data.consultation_id } });
    } catch (error) {
      ...
      setProcessingError(error instanceof Error ? error.message : "Unknown local pipeline error.");
      setPhase("idle");
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col items-center px-6 py-8">
        ...
        <div className="w-full space-y-5 rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/40 p-2.5 rounded-lg border border-border">
            ...
            <span>
              Engine: <strong>Whisper {whisperModel.toUpperCase()}</strong> + Silero VAD Filter +
              Medical Vocabulary Priming + Local ICD-10 & Rx Auto-Mapping.
            </span>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          {(phase === "recording" || phase === "paused") && (
            <>
              ...
              <div className="mt-8 flex h-12 items-center gap-[3px]">
                {Array.from({ length: 36 }).map((_, i) => {
                  ...
                  const dynamicHeight = Math.max(
                    baseHeight,
                    Math.round(baseHeight * (audioLevel / 20)),
                  );
                  return (
                    <span
                      key={i}
                      ...
                      style={{
                        height: `${phase === "paused" ? 8 : Math.min(44, dynamicHeight)}px`,
                      }}
                    />
                  );
                })}
              ...
              <p className="mt-4 font-serif text-3xl tabular-nums text-foreground">
                {fmt(seconds)}
              </p>
